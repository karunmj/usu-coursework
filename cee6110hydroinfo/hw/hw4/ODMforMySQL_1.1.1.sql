...
-- Note:  If you called your schema something other than 'odm', modify the following line of code to point at the right schema
...
--
-- Create the Stored Procedure to update the SeriesCatalog Table
--

DROP procedure IF EXISTS `sp_UpdateSeriesCatalog`;

DELIMITER $$
USE `odm`$$
CREATE PROCEDURE `sp_UpdateSeriesCatalog` ()
BEGIN
